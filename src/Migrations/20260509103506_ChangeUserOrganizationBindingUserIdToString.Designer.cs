...
namespace backend.Migrations
{
    ...
    [Migration("20260509103506_ChangeUserOrganizationBindingUserIdToString")]
    partial class ChangeUserOrganizationBindingUserIdToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.FriendRequest.FriendRequests", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.Notification.Notifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Models.UserEventBinding.UserEventBindings", b =>
                {
                    ...
                    b.HasIndex("UserId", "OrganizationEventsId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Models.Notification.Notifications", b =>
                {
                    b.HasOne("Models.User.Users", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.UserEventBinding.UserEventBindings", b =>
                {
                    b.HasOne("Models.OrganizationEvent.OrganizationEvents", "OrganizationEvent")
                        ...
                        .HasForeignKey("OrganizationEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
